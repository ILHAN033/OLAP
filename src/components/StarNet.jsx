...
function StarNet({
  ...
  useEffect(() => {
    ...
    axios
      .get("http://20.2.249.58:8000/tables")
  ...
  const fetchColumns = (tableName, setColumns) => {
    ...
    axios
      .get(`http://20.2.249.58:8000/columns/${tableName}`)
  ...
  const handleRollup = async () => {
    try {
      const response = await axios.post("http://20.2.249.58:8000/rollup", {
        measureTable,
        measureColumn,
        dimensionTable,
        dimensionColumn,
  ...
  const handleDrilldown = async () => {
    try {
      const response = await axios.post("http://20.2.249.58:8000/drilldown", {
        measureTable,
        measureColumn,
        dimensionTable,
        dimensionColumn,
  ...
  const handleSlice = async () => {
    try {
      const response = await axios.post("http://20.2.249.58:8000/slice", {
        dimensionTable,
        dimensionColumn,
  ...
  const handleDice = async () => {
    try {
      const response = await axios.post("http://20.2.249.58:8000/Dice", {
        dimensionTable,
        dimensionTable2,
        dimensionColumn,
        dimension2Column,
